...
class AdminFotografiaListingTest extends TestCase
{
    ...
    public function test_listing_uses_thumbnail_version_when_available(): void
    {
        $fotografia = $this->fotografia([
            'titulo' => 'Praça central com miniatura',
        ]);
        ...
        $this
            ...
            ->assertSee('Miniatura de Praça central com miniatura', false);

        $this->assertSame(2, Arquivo::count());
    }

    public function test_listing_uses_fallback_when_thumbnail_is_not_available(): void
    {
        $this->fotografia(['titulo' => 'Fotografia sem derivada']);
